...
module.exports = {
   ...
   *
   * @param     {consent_msg, consent_signature, linked_did}  ethProof  The claim generated by getLinkConsent
   * @return    {String}                                                The ethereum address used to sign the message
   */
  verifyEthereum: async (ethProof) => {
    const { consent_msg, consent_signature } = ethProof
    return ethers.utils.verifyMessage(consent_msg, consent_signature)
  }
}
