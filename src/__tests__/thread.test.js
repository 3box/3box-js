...
describe('Thread', () => {
  ...
  it('creates thread correctly', async () => {
    thread = new Thread(THREAD1_NAME, replicatorMock, THREEID1_MOCK, false, DID1, subscribeMock)
  })
  ...
  it('defaults to user as root moderator and no members ', async () => {
    const threadDefault = new Thread(THREAD3_NAME, replicatorMock, THREEID1_MOCK, undefined, undefined, subscribeMock)
  ...
  it('root moderator can add another moderator', async () => {
    const threadMods = new Thread(THREAD3_NAME, replicatorMock, THREEID1_MOCK, false, DID1, subscribeMock)
  ...
  it('user who is not moderator can NOT add a moderator', async () => {
    const threadMods = new Thread(THREAD3_NAME, replicatorMock, THREEID1_MOCK, false, DID2, subscribeMock)
    await threadMods._load()
  ...
  it('a moderator can add another moderator', async () => {
    ...
    const threadMod1 = new Thread(threadName, replicatorMock, THREEID1_MOCK, false, DID1, subscribeMock)
    ...
    const threadMod2 = new Thread(threadName, replicatorMock, THREEID2_MOCK, false, DID1, subscribeMock)
  ...
  it('moderator can add a Member', async () => {
    const threadName = randomThreadName()
    const threadMembers = new Thread(threadName, replicatorMock, THREEID1_MOCK, true, DID1, subscribeMock)
  ...
  it('user who is not a moderator can NOT add a Member', async () => {
    const threadName = randomThreadName()
    const threadMembers = new Thread(threadName, replicatorMock, THREEID1_MOCK, true, DID2, subscribeMock)
    await threadMembers._load()
  ...
  it('throws if using member operations on a non member thread', async () => {
    const threadName = randomThreadName()
    const threadMembers = new Thread(threadName, replicatorMock, THREEID1_MOCK, false, DID1, subscribeMock)
    await threadMembers._load()
  ...
  it('a moderator can delete other users posts', async () => {
    const threadName = randomThreadName()
    const thread1 = new Thread(threadName, replicatorMock, THREEID1_MOCK, false, DID2, subscribeMock)
    await thread1._load()
    await thread1.post(MSG1)
    const posts = await thread1.getPosts()
    const entryId = posts[0].postId
    const thread2 = new Thread(threadName, replicatorMock, THREEID2_MOCK, false, DID2, subscribeMock)
    await thread2._load()
  ...
  it('user without being a moderator can NOT delete others posts', async () => {
    const threadName = randomThreadName()
    const thread1 = new Thread(threadName, replicatorMock, THREEID1_MOCK, false, DID3, subscribeMock)
    await thread1._load()
    await thread1.post(MSG1)
    const posts = await thread1.getPosts()
    const entryId = posts[0].postId
    const thread2 = new Thread(threadName, replicatorMock, THREEID2_MOCK, false, DID3, subscribeMock)
    await thread2._load()
  ...
  it('user without being a moderator can delete their own posts', async () => {
    const threadName = randomThreadName()
    const thread = new Thread(threadName, replicatorMock, THREEID1_MOCK, false, DID3, subscribeMock)
    await thread._load()
    await thread.post(MSG1)
  ...
  it('non member can NOT post to a members thread', async () => {
    const threadName = randomThreadName()
    const thread1 = new Thread(threadName, replicatorMock, THREEID1_MOCK, true, DID3, subscribeMock)
    await thread1._load()
  ...
  it('a member can post in a members only thread', async () => {
    const threadName = randomThreadName()
    const thread1 = new Thread(threadName, replicatorMock, THREEID1_MOCK, true, DID1, subscribeMock)
    await thread1._load()
    await thread1.addMember(DID2)
    expect(await thread1.listMembers()).toEqual([DID2])
    const thread2 = new Thread(threadName, replicatorMock, THREEID2_MOCK, true, DID1, subscribeMock)
    await thread2._load()
  ...
  it('a thread can be loaded by its address only', async () => {
    const threadName = randomThreadName()
    const thread1 = new Thread(threadName, replicatorMock, THREEID1_MOCK, false, DID1, subscribeMock)
    await thread1._load()
    const thread1Address = thread1.address
    await thread1.post(MSG1)
    const posts = await thread1.getPosts()
    const entryId = posts[0].postId
    const thread2 = new Thread(threadName, replicatorMock, THREEID2_MOCK, undefined, undefined, subscribeMock)
  ...
  describe('multi user interaction', () => {
    ...
    it('syncs thread between users', async () => {
      threadUser1 = new Thread(THREAD2_NAME, replicatorMock, THREEID1_MOCK,false, DID1, subscribeMock)
      await threadUser1._load()
      threadUser2 = new Thread(THREAD2_NAME, replicatorMock2, THREEID2_MOCK, false, DID1,subscribeMock)
    ...
    it('moderator capabilities are shared/synced between users', async () => {
      const threadName = randomThreadName()
      threadUser1 = new Thread(threadName, replicatorMock, THREEID1_MOCK,false, DID1, subscribeMock)
      await threadUser1._load()
      threadUser2 = new Thread(threadName, replicatorMock2, THREEID2_MOCK, false, DID1,subscribeMock)
      await threadUser2._load()
    ...
    it('member capabilities are shared/synced between users', async () => {
      const threadName = randomThreadName()
      threadUser1 = new Thread(threadName, replicatorMock, THREEID1_MOCK, true, DID1, subscribeMock)
      await threadUser1._load()
      threadUser2 = new Thread(threadName, replicatorMock2, THREEID2_MOCK, true, DID1, subscribeMock)
      await threadUser2._load()
